...
```
This functino was both much easier to write and much faster to run.
...
FizzBuzz <- function(n){
  ...
  result <- NULL
  for(i in 1:n){
    fivetracker <- fivetracker + 1
    threetracker <- threetracker + 1
    if(fivetracker == 5 && threetracker == 3){
      result[i] <- "Fizz Buzz"
      fivetracker <- 0
      threetracker <- 0
    }else if(fivetracker == 5){
      result[i] <- "Buzz"
      fivetracker <- 0
    } else if(threetracker == 3){
      result[i] <- "Fizz"
      threetracker <- 0
    } else{
      result[i] <- i
